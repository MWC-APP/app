...
public class HomeFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        // Ensure the hosting activity implements the NavigationLocker interface.
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Notify the ViewModel that the UI is ready, which can help reset states
        ...
        startSessionButton.setOnClickListener(v -> {
            ...
            if (homeViewModel.currentState.getValue() != HomeViewModel.PomodoroState.IDLE) {
                ...
                // Otherwise, start a new session with the saved settings.
                startDefaultSession();
            }
        });
    }
    ...
    private void setupObservers() {
        ...
        homeViewModel.currentState.observe(getViewLifecycleOwner(), state -> {
            ...
            // Lock the bottom navigation during study sessions.
    ...
    private void startDefaultSession() {
        ...
        homeViewModel.pomodoroTechnique(2, 1, longPauseDuration);
    }
